...
export default function Register() {
  ...
  const getIndonesianErrorMessage = (errorMessage: string) => {
    ...
    if (errorLower.includes("required")) {
      return "Email, username, dan password harus diisi";
    }
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 pr-10 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-slate-900"
                required
              />
              <button
                type="button"
